package com.cgi.etcp.crud.owner.dto;
...
public class OwnerDTO {
    ...
    public static OwnerDTO of(final OwnerModel pModel) {
        return new OwnerDTO(pModel.getId(), pModel.getName(), pModel.getLanguage(),
                pModel.getCreated(), pModel.getCreatedBy(), pModel.getUpdated(), pModel.getUpdatedBy());
    }
